...
struct Baralho {
    std::vector<Carta> cartas_baralho = {
        {Naipes::COPAS, Tipos_Cartas::AS},{Naipes::COPAS, Tipos_Cartas::DOIS},
        {Naipes::COPAS, Tipos_Cartas::TRES},{Naipes::COPAS, Tipos_Cartas::QUATRO},
        {Naipes::COPAS, Tipos_Cartas::CINCO},{Naipes::COPAS, Tipos_Cartas::SEIS},
        {Naipes::COPAS, Tipos_Cartas::SETE},{Naipes::COPAS, Tipos_Cartas::REI},
        {Naipes::COPAS, Tipos_Cartas::RAINHA},{Naipes::COPAS, Tipos_Cartas::VALETE},
