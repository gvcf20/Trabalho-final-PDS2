...
class Vencedor{
    ...
    std::pair<unsigned int, unsigned int> pontos_sub_rodada_vencedor(std::pair<Dupla, Dupla>& duplas, std::vector<Carta>& cartas_jogadas, unsigned pt);
    std::pair<unsigned int, unsigned int> pontos_sub_rodada_empate(std::pair<Dupla, Dupla>& duplas, std::vector<Carta>& cartas_jogadas, unsigned pt);
